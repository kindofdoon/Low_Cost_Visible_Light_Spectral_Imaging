function hyperspectral_image_GUI
    ...
    Zero_Slope.pos = [GUI.input_x, CWL_Res.pos(2)-GUI.gap_large, GUI.input_dims];
    uicontrol('Style','text', 'String','Zero Mean SPD Slope', 'Position',[GUI.label_x, Zero_Slope.pos(2)-GUI.label_off_vert, GUI.label_dims], 'BackgroundColor','w', 'FontSize',GUI.fs,'HorizontalAlignment','left');
    Zero_Slope.handle = uicontrol('Style','checkbox', 'String','', 'Position',Zero_Slope.pos, 'BackgroundColor',GUI.col_bac, 'FontSize',GUI.fs);
    
    Gain_R.pos = [GUI.input_x, Zero_Slope.pos(2)-GUI.gap_small, GUI.input_dims];
    ...
    GIF_Duration.pos = [GUI.input_x, Mesh_Density.pos(2)-GUI.gap_small, GUI.input_dims];
    ...
    function generate_image
        ...
        if get(Zero_Slope.handle,'value')
        ...
        switch Image.mode
            ...
            case 'export'
                ...
                imwrite(Image.RGB, [Photo.pathdir '\' fn_export '.jpg'])
    ...
    function update_filters
        ...
        figure(5)
            set(gcf,'Name','Filter Transmission Spectra','NumberTitle','off','MenuBar','none','ToolBar','none')
            clf
            hold on
            set(gcf,'color','white')
            for f = 1 : Filter.qty
